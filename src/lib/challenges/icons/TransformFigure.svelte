<script lang="ts">
	...
	export let id = 'TransformFigureIcon';
	export let classString = 'interactiveIcon';
	export let style = '';
</script>
...
>
	<g>
		<path
			d="M52,0v3c-0.553,0-1,0.447-1,1s0.447,1,1,1v3h3c0,0.553,0.447,1,1,1s1-0.447,1-1h3V0H52z M58,6h-4V2h4V6z"
		/>
		<path d="M5,22c0-0.553-0.447-1-1-1s-1,0.447-1,1v1c0,0.553,0.447,1,1,1s1-0.447,1-1V22z" />
		<path
			d="M4,46c-0.553,0-1,0.447-1,1v1c0,0.553,0.447,1,1,1s1-0.447,1-1v-1C5,46.447,4.553,46,4,46z"
		/>
		...
		<path
			d="M4,9c0.553,0,1-0.447,1-1h3V5c0.553,0,1-0.447,1-1S8.553,3,8,3V0H0v8h3C3,8.553,3.447,9,4,9z M2,6V2h4v4H2z"
		/>
		...
		<path
			d="M56,14c0.553,0,1-0.447,1-1v-1c0-0.553-0.447-1-1-1s-1,0.447-1,1v1C55,13.553,55.447,14,56,14z"
		/>
		<path d="M55,23c0,0.553,0.447,1,1,1s1-0.447,1-1v-1c0-0.553-0.447-1-1-1s-1,0.447-1,1V23z" />
		<path
			d="M56,51c-0.553,0-1,0.447-1,1h-1.318L45,29.811V23h-8v3H23v-3h-8v6.811L6.317,52H5c0-0.553-0.447-1-1-1s-1,0.447-1,1H0v8h8
